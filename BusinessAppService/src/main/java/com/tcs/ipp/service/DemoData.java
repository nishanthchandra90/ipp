...
public class DemoData {
    ...
    public void appReady(ApplicationReadyEvent event) {
        ...
        buildingRepo.saveAll(List.of(new Building("Abhilash - STP"),
                ...
                new Building("Hyderabad - Non STP"),
