...
public class DemoData {
    ...
    public void appReady(ApplicationReadyEvent event) {
        ...
        employeeRepo.saveAll(List.of(
                ...
                new EmployeeDto("emp-2332332", "12345", "blob.byne@tcs.com",
                        "blob byne", 6, 0, "TCS - Mumbai", "GG VII - STP",
                        "Cloud", "GOOGLE", "", "java", false),
                new EmployeeDto("emp-273698646", "12345", "alice.ar@tcs.com",
                        "alice ar", 3, 8, "TCS - Nagpur", "GG VII - STP",
                        "Cloud", "GOOGLE", "", "java", false),
                new EmployeeDto("emp-9876372", "12345", "wells.white@tcs.com",
                        "wells white", 10, 3, "TCS - Mumbai", "GG VII - STP",
                        "Cloud", "GOOGLE", "", "java", false),
                new EmployeeDto("emp-03843984", "12345", "micheal.est@tcs.com",
